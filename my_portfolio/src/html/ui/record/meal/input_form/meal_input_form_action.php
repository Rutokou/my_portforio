...
// 食事記録データ入力用
require_once('../../../../class/db/record/meal/InputMeal.php');
...
try {
    ...
    if ($_POST['input']) {
        // インスタンス生成
        $db = new InputMeal();
        $db->insertMeal($_POST['registration_date'], $_POST['user_id'], $_POST['breakfast'], $_POST['lunch'], $_POST['dinner'], $_POST['evaluated'], $_POST['meal_management_assessment']);
    }
