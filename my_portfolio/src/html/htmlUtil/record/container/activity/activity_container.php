<div class="container-fluid">
    ...
    <form class="form-inline mr-auto mt-2 mt-lg-0" method="get" action="./activity.php">
        ...
        <input class="form-control mr-sm-2" type="search" placeholder="活動記録から検索" value="<?= $search ?>" name="search">
