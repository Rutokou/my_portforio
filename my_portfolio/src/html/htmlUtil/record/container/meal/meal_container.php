<div class="container-fluid">
    ...
    <form class="form-inline mr-auto mt-2 mt-lg-0" method="get" action="./meal.php">
        ...
        <input class="form-control mr-sm-2" type="search" placeholder="食事記録から検索" value="<?= $search ?>" name="search">
